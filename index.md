...
<body>
	...
	<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
		<div class="intro">
			<div class="intro-sub">Yovin Silaban</div>
			<h1>Engineering <span>Network </span></h1>
      ...
      <div class="social-icons">
        <ul class="list-inline">
          <li><a href="https://www.facebook.com/yovinsilaban07"><i class="fa fa-facebook"></i></a></li>
          <li><a href="https://www.instagram.com/yovin_silaban/"><i class="fa fa-instagram"></i></a></li>
          <li><a href="https://github.com/yovinsilaban"><i class="fa fa-github"></i></a></li>
          <li><a href="https://dribbble.com/yovinsilaban"><i class="fa fa-dribbble"></i></a></li>
          <li><a href="https://www.linkedin.com/in/yovin-silaban-37b768131"><i class="fa fa-linkedin"></i></a></li>
        </ul>
      </div> <!-- /.social-icons -->
		</div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-push-8">
            <div class="biography">
              ...
              <ul>
                ...
                <li><strong>Name      		: </strong>  Yovin Silaban</li>
                <li><strong>Date of birth 	: </strong>  01 February 1997</li>
                <li><strong>Address       	: </strong>  Pasar Tebat Bengkulu Utara</li>
                <li><strong>Nationality   	: </strong>  INDONESIA</li>
                <li><strong>Phone         	: </strong>  085357779131</li>
                <li><strong>Email         	: </strong>  yovinsilaban07@gmail.com</li>
              </ul>
			  </font>
            </div>
          </div> <!-- col-md-4 -->
          ...
          <div class="col-md-8 col-md-pull-4">
            <div class="short-info wow fadeInUp">
              <h3>Objective</h3>
              <span align="justify"><p>Nama saya Yovin Silaban, Saya lahir pada  tanggal 1 february 1997, Saya berasal dari Pasar Tebat Bengkulu Utara, disini saya tinggal Jl Kp Harap Berbah, Sleman Yogyakarta. Saya merupakan anak ke-2 dari tiga bersaudara. Ayah Saya Seorang Petani, Dia memiliki hobi bermain alat musik seperti keyboard dan gitar, Ibu saya seorang guru sd yang mengajar di SDN 07 Pukur Bengkulu Utara. Saya memiliki seorang adik bernama Harri silaban sekarang dia kelas 2 SMA, saya juga memiliki seorang kakak nama nya Alax silaban sekarang dia kerja di salah satu PT di muko-muko.</p></span>
            </div>

            <div class="short-info wow fadeInUp">
              <h3>What I Do ?</h3>
              <span align="justify"><p>Saya tidak pandai TAPI saya juga tidak bodoh, Saya tidak punya banyak Keahlihan TAPI ada yang saya bisa.</p></span>
                        ...
                        <ul class="timeline">
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>SD NEGERI 02 PASAR TEBAT BENGKULU UTARA  </h3>
                                            <span>38373, Jl. Lintas Sumatra, Pasar Tebat</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <span align="justify"><p> Saya telah menyelesaikan Sekolah Dasar/SD, Selama 6 Tahun lamanya Tepatnya Mulai Tahun 2003-2009 Di SD Negeri 02 Air Napal Bengkulu Utara.</p></span>
                                        </div><!-- /timeline-body -->
                            ...
                            <li class="timeline-inverted">
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>SMP NEGERI 1 AIR NAPAL BENGKULU UTARA</h3>
                                            <span>38373, Jl. Lintas Sumatra, Talang Jarang</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <span align="justify"><p>Setelah lulus Sekolah Dasar/SD, Saya melanjutkan ke Pendidikan saya di SMP Negeri 01 Air Napal Selama 3 Tahun Tepatnya Mulai Tahun 2009-2012.</p></span>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div> <!-- /timeline-panel -->
                            </li>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>SMK NEGERI 03 KOTA BENGKULU</h3>
                                            <span>38228, Jl. Jati No. 42 Sawah Lebar </span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <span align="justify"><p>Sejak tahun 2012, saya sudah berpisah dari kedua orang tua saya utuk melanjutkan pendidikan saya di SMK Negeri 03 Kota Bengkulu dan lulus pada tahun 2015.</p></span>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div><!-- /timeline-panel -->
                            </li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="copyright text-center">
              <p>&copy; finshi02 2018. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
